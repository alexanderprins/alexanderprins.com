...
export const projects: Project[] = [
  {
    ...
    images: [
      ...
      },
      {
        ...
        card: "thumb",
        cardOrder: 1,
        src: "/work/hello-marjorie/thumb-1.jpg",
        alt: "A rosemary-garnished cocktail on the bar at Hello, Marjorie, warm lamplight and red leather stools behind",
      },
      {
        type: "detail",
        card: "thumb",
        cardOrder: 2,
        src: "/work/hello-marjorie/thumb-2.png",
        alt: "Both sides of the redesigned Hello, Marjorie menu laid flat, the cocktail list and the back",
      },
      {
        type: "lifestyle",
        card: "thumb",
